...
import { mockPosters } from "@/lib/storage-mock-data";
...
export default function StoragePostersPage() {
  const [items, setItems] = useState<BaseItem[]>(mockPosters);
  ...
  return (
    <div className="mx-auto max-w-[1120px] pb-12">
      <div>
        <h1 className="mb-4 text-2xl font-bold text-white">포스터</h1>
      </div>
